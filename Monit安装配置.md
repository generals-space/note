...
[如何使用Monit部署服务器监控系统](http://www.linuxidc.com/Linux/2015-05/118237.htm)

[Monit监控工具的使用](http://blog.csdn.net/fan_hai_ping/article/details/41733783)

## 1. 依赖包

```
$ yum install autoconf automake libtool flex bison zlib-devel pam-devel openssl-devel
```
...
#
## set logfile syslog
set logfile /var/log/monitd.log
...
set httpd port 2812 and
    ...
    allow devops:hh1q2w3edd4r5t6y      # require user 'admin' with password 'monit'
...
#    then alert
#
## 网络连接监控, 可以监控连接状态, 流量变化, 所占峰值百分比和带宽使用情况等
#
